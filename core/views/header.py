...
class Header:
    def __init__(self, header_title: str='Default title', visible_button_menu: bool=True, **kwargs):
        self._header_title = header_title
        self._visible_button = visible_button_menu
        self._visible_button_info = kwargs.get('visible_button_info', None)
        self._icon_main = kwargs.get('icon_main', None)
        #self._change_theme = kwargs.get('change_theme', None)
        self._navigation_drawer = kwargs.get('menu', None)
    ...
    def build(self) -> ft.AppBar:
        return ft.AppBar(
                leading=ft.Row([
                    self._icon_button_navigation_drawer(),
    ...
    def _icon_button_navigation_drawer(self) -> ft.IconButton:
        return ft.IconButton(
                icon=ft.icons.MENU,
                ...
                selected=False,
                visible=self._visible_button,
                on_click=self._navigation_drawer,
            )
    ...
    def _icon_button_about(self) -> ft.IconButton:
        return ft.IconButton(
                ...
                style=ft.ButtonStyle(color=ft.colors.BLUE_500),
                tooltip="Acerca de",
                visible=self._visible_button_info,
